...
"Any significant grouping of dense vegetation, typically with a closed or dense canopy. Taller and darker than the surrounding vegetation (if surrounded by other vegetation)",
"Inland water bodies generally include large rivers lakes and water reservoirs.",
"Areas of any type of vegetation with obvious water mixing. Do not assume an area is flooded if flooding is seen in another image. Seasonally flooded areas that are a mixture of grass/shrubs/trees/bare ground.",
...
"A mixture of small clusters of plants or individual plants scattered across a landscape that features exposed soil and rock. Bush-filled clearings in dense forests that are clearly no taller than the trees. They appear grayer/brown due to less dense leaf coverage",
"Scattered trees with a canopy cover of less than 10 percent, small groups of trees less than 0.5 hectares and tree lines less than 20 meters wide.",
...
"Este subgrupo de formação apresenta características fisionômicas muito típicas, com arbustos e pequenas árvores, em geral de mesma espécie, e distribuição bastante espaçada, qual fossem plantados. Afigura-se como uma pseudo-ordenação de plantas lenhosas sobre denso tapete, principalmente, de plantas herbáceas e gramíneas. Dominam várias espécies, dentre as quais se destacam Mimosa acutistipula (Mart.) Benth. (Fabaceae Mim.), associada a outras do gênero que, embora de ampla dispersão, dominam na América tropical; Auxemma oncocalyx (Allemão) Baill. (Borraginaceae - pau-branco) Combretum leprosum Mart. (Combretaceae - mofumbo) e Aspidosperma pyrifolium Mart. (Apocynaceae - pereiro), ambas famílias pantropicais, contudo, de gêneros afro-amazônicos, sendo o último andino-argentino. Estão sempre associados ao capim-panasco, do gênero Aristida, de dispersão mundial, principalmente nas Zonas Paleotropical e Neotropical",
...
"Scattered trees with a canopy cover of less than 10 percent, small groups of trees less than 0.5 hectares and tree lines less than 20 meters wide",
"Se caracterizam por um estrato predominantemente arbustivo, esparsamente distribuído sobre um tapete gramíneo-lenhoso.",
"Prevalecem nesta fisionomia, quando natural, os gramados entremeados por plantas lenhosas raquíticas, que ocupam extensas áreas dominadas por hemicriptófitos e que, aos poucos, quando manejados através do fogo ou pastoreio, vão sendo substituídos por geófitos que se distinguem por apresentar colmos subterrâneos, portanto mais resistentes ao pisoteio do gado e ao fogo",
"A mixture of small clusters of plants or individual plants scattered across a landscape that features exposed soil and rock. Bush-filled clearings in dense forests that are clearly no taller than the trees. They appear grayer/brown due to less dense leaf coverage.",
...
"Subgrupo de formação constituído essencialmente por um estrato graminoide, integrado por hemicriptófitos e geófitos de florística natural ou antropizada, entremeado por nanofanerófitos isolados, com conotação típica de um “Parque Inglês” (Parkland). A Savana Parque de natureza antrópica é encontrada em todo o País, enquanto a natural ocorre algumas vezes com feição de campos litossólicos e/ou rupestres. Em áreas encharcadas de depressões periodicamente inundadas, ocorrem as tipologias naturais de Cerrado-de-Pantanal, com denominações regionais diversas, caracterizadas pela presença de “covoais”, “monchões” ou murundus",
"Land spanning more than 0.5 hectares with trees higher than 5 meters and a canopy cover of more than 10 percent, or trees able to reach these thresholds in situ. It does not include land that is predominantly under agricultural or urban land use.",
...
"Any significant grouping of dense vegetation, typically with a closed or dense canopy. Taller and darker than the surrounding vegetation (if surrounded by other vegetation).",
"Subgrupo de formação no qual predominam arbustos cespitosos e ervas, densamente distribuídos e eventualmente entremeados por árvores baixas, geralmente entendida como uma das fisionomias de Campina Amazônica, que ocorrem preferencialmente nas áreas das depressões fechadas com Espodossolos. Na sua maioria, as espécies são as mesmas da Campinarana Arborizada, sendo a principal característica diferencial entre elas a altura de seus componentes, que raramente ultrapassam 2 m. Essa redução do porte arbóreo está na dependência do nível e da duração do encharcamento do solo e seu grau de oligotrofismo, fatores que influenciam ainda na densidade dos indivíduos e na coloração das folhas, que passam ao verde pálido, bem como na maior tortuosidade dos troncos, resultando numa fisionomia que se caracteriza por um porte raquítico. Nesta formação, também se inclui a fisionomia arbustiva densa de “Caatinga-Gapó”, às vezes denominada como “varetal”, típica das planícies e áreas cujo encharcamento é quase permanente.",
"Este subgrupo de formação puramente herbáceo constitui se na verdadeira Campina. Surge ao longo das planícies encharcadas dos rios de águas pretas e também nas depressões fechadas dos interflúvios tabulares, capeados pelo Espodossolo. No caso das depressões, em geral com formas circulares, o encharcamento e a fisionomia pantanosa limitam-se ao período chuvoso, tornando-se bastante árida e seca no auge da estação desfavorável. Neste período, em certas áreas, ocorrem queimadas que têm modificado bastante sua estrutura e composição.",
...
"Open areas covered by homogeneous grasses with little or no taller vegetation. Other homogeneous areas of grass-like vegetation (blade-like leaves) that appear different from trees and shrubs. Cereals and wild grasses with no obvious human plot (i.e. without a structured field).",
"Scattered trees with a canopy cover of less than 10 percent, small groups of trees less than 0.5 hectares and tree lines less than 20 meters wide",
"associados ao plano mais alto das praias contribuem para caracterizar esta comunidade pioneira: Acicarpha, Achyrocline, Polygala, Spartina, Vigna e outros de menor importância caracterizadora. Uma espécie de Arecaceae que ocorre nas restingas desde Sergipe até o Rio de Janeiro é a Allagoptera arenaria (Gomes) Kuntze, provável “vicariante” da A. campestris (Mart.) Kuntze da Savana planáltica do interior brasileiro.",
"All land that is not classified as forest or other wooded land.",
"As comunidades vegetais que recebem influência direta das águas do mar apresentam gêneros característicos das praias Remirea e Salicornia. ",
...
"Areas of rock or soil containing little or no vegetation. Large areas of sand and deserts with little or no vegetation. Large individual or dense networks of dirt roads.",
